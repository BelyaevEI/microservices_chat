...
func (m *CreateResponse) validate(all bool) error {
	...
	if _, ok := _CreateResponse_Id_NotInLookup[m.GetId()]; ok {
...
var _CreateResponse_Id_NotInLookup = map[int64]struct{}{
	0: {},
}
...
func (m *DeleteRequest) validate(all bool) error {
	...
	if _, ok := _DeleteRequest_Id_NotInLookup[m.GetId()]; ok {
...
var _DeleteRequest_Id_NotInLookup = map[int64]struct{}{
	0: {},
}
...
func (m *SendMessageRequest) validate(all bool) error {
	...
	if _, ok := _SendMessageRequest_FromUserId_NotInLookup[m.GetFromUserId()]; ok {
	...
	if _, ok := _SendMessageRequest_ToChatId_NotInLookup[m.GetToChatId()]; ok {
		err := SendMessageRequestValidationError{
			field:  "ToChatId",
			reason: "value must not be in list [0]",
		}
...
var _SendMessageRequest_FromUserId_NotInLookup = map[int64]struct{}{
	0: {},
}

var _SendMessageRequest_ToChatId_NotInLookup = map[int64]struct{}{
	0: {},
}
...
func (m *SendMessageResponse) validate(all bool) error {
	...
	if _, ok := _SendMessageResponse_ChatId_NotInLookup[m.GetChatId()]; ok {
...
var _SendMessageResponse_ChatId_NotInLookup = map[int64]struct{}{
	0: {},
}
